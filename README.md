...
- **Технологии:** REST API, Docker, Git, Celery, Redis, JWT, SQLAlchemy, pytest, Poetry  
- **Фреймворки и библиотеки:** Django, Django REST Framework (DRF), requests, psycopg2, drf-yasg, pillow, python-dotenv, black, isort
